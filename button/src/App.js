...
class App extends Component {
  ...
  componentDidMount(){
    if(window.location.href.split("?")[1] != undefined){
      ...
      if(link.split("/")[3] == "stores"){
        this.setState({
          isWrongLink: false,
          code: `
          <link rel="stylesheet" type="text/css" media="all" href="https://vdthatte.github.io/button-css/button.css" >
          <a class="omni-rent-button-white" href="` + link + `" target="_blank"><img class="omni-rent-button-logo" src="https://raw.githubusercontent.com/vdthatte/embed-styles/master/logo.png"/>` + this.state.title +`</a>`,
          showButton: true,
          storeLink : window.location.href.split("?")[1]
        })
      }
    }
  }
